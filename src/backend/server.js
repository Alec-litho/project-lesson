...
const {create, getAll, getOne, deletePost, update, getMyPosts, getPostImages, getComments, postComment, postReply, deleteComment,postSmashLike} = require('./controllers/postController')
